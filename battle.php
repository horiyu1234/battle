...
<p>
<input type="radio" name="gokiburi" value="1" checked>余裕っしょ。<br>
...
<p>
<input type="radio" name="mascle" value="1" checked>体重100kg以上のゴリマッチョだ。<br>
...
<p>
<input type="radio" name="study" value="0.8" checked>東大とか余裕だぜ。<br>
...
<p>
<input type="radio" name="combat_art" value="1" checked>やってる。雑魚が何人かかってきても相手にならないぜ。<br>
...
<p>
<input type="radio" name="gojira" value="0.5" checked>大事な人を連れて逃げる。<br>
...
<p>
<input type="radio" name="animal" value="0.5" checked>声が聞こえる。<br>
...
<p>
<input type="radio" name="destination" value="0.01" checked>まあ、安定のタクシー<br>
...
<p>
<input type="radio" name="pirate" value="0.8" checked>財閥の力を駆使して部下に財宝を取りにいかせる。<br>
...
<p>
<input type="radio" name="philosophy" value="0.8" checked>何事にも通じる考え方はもっている。<br>
...
<p>
<input type="radio" name="want" value="1" checked>今の自分が大好きだ。<br>
